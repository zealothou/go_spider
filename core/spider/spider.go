...
import (
	...
	"github.com/zealothou/go_spider/core/common/page_items"
	"github.com/zealothou/go_spider/core/common/request"
	"github.com/zealothou/go_spider/core/common/resource_manage"
	"github.com/zealothou/go_spider/core/downloader"
	"github.com/zealothou/go_spider/core/page_processer"
	"github.com/zealothou/go_spider/core/pipeline"
	"github.com/zealothou/go_spider/core/scheduler"
	//"fmt"
)

type BeforeRequest func(req *request.Request)
...
func (this *Spider) OnBeforeRequest(callback BeforeRequest) *Spider {
